...
namespace FinancialPortal.Models
{
    ...
    public class ChangeNegativeFormatViewModel : BaseViewModel
    {
        [Required(ErrorMessage = "Required")]
        public int? FormatSelection { get; set; }
        public Dictionary<int, string> FormatList { get; set; }
        public ChangeNegativeFormatViewModel()
        {
            FormatList = new Dictionary<int, string>();
        }
